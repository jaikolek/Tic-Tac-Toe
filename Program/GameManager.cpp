...
void GameManager::play()
{
	...
	std::cout << "\nStatistika: " << std::endl;
	std::cout << "PLAYER 1 \n" << "Username: " << Player_1.get_username() << "\n" << "Win: " << Player_1.get_win_count() << std::endl << std::endl;
	std::cout << "PLAYER 2 \n" << "Username: " << Player_2.get_username() << "\n" << "Win: " << Player_2.get_win_count() << std::endl << std::endl;
